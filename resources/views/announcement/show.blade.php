      ...
      <div class="col-12">
        <div class="card mb-3">
          ...
          <div class="col-6 d-flex justify-content-start p-2">
            <a href="{{route('announcement.index')}}" class="detail-icon me-2 d-flex justify-content-center align-items-center" style="width: 40px ; height:40px;  position:relative;">
              <i class="fas fa-chevron-left px-2"></i>
              <p class="hover-text">Torna indietro</p>
            </a>
            <a href="{{route('announcement.edit', compact('announcement'))}}" class="detail-icon me-2 d-flex justify-content-center align-items-center"  style="width: 40px ; height:40px ; position:relative;">
              <i class="fas fa-pen "></i>
              <p class="hover-text">Modifica</p>
            </a>
            <form action="{{route('announcement.destroy', compact('announcement'))}}" method="post">
              @csrf
              @method('delete')
              <button class=" detail-icon d-flex justify-content-center align-items-center"  style="width: 40px ; height:40px;">
                <i class="fas fa-times"></i>
                <p class="hover-text">Elimina</p>
              </button>
            </form>
        </div>
        </div>
