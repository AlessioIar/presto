          ...
          <div class="card-body text-center">
            ...
            <p class="card-subtitle m-2 icon-color fw-bold">€ {{$announcement->price}}</p>
              <div class="col-12 d-flex justify-content-between">
                  ...
                  <a href="{{route('announcement.show',["announcement"=>$announcement,"title"=>$announcement->path()])}}" class="detail-icon d-flex justify-content-center align-items-center" style="width: 40px ; height:40px; position:relative;">
